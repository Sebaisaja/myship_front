          ...
          <Row className=' justify-content-center'>
            <Col md={6}>
              <Card className='p-5'>
                ...
                <p className='mb-2 text-md'>
                  {' '}
                  Adresse : {nationalRapidPost?.expediteur.address}
                </p>
                ...
                <p className='mb-2 text-md'>
                  Adresse : {nationalRapidPost?.destinataire.address}
                </p>
                ...
                {nationalRapidPost?.method === 'online' ? (
                  ...
                  <p className='mb-1'>Méthode : Payer en agence</p>
                )}

                <h4 mt='mt-2'>Montant : {nationalRapidPost?.price} DNT</h4>
              </Card>
            </Col>
          </Row>
        </Container>
...
export default InternationalRpPrint;
